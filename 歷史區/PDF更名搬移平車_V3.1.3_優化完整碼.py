# -*- coding: utf-8 -*-
# =========================================================
# PDF更名搬移平車 Ver 3.1.3 精簡修正版 OCR 搬移整合版
# =========================================================
# 保留原功能：
...
class PDFRenameTool:
    ...
    def create_ui(self):
        ...
        self.tab_bar.pack(side="right", fill="y", padx=(0, 12), pady=12)
    ...
    def create_treeview(self, parent):
        ...
        self.tree.column("filename", width=430, minwidth=260, stretch=False)
    ...
    def create_move_area(self, parent):
        ...
        self.move_tree.column("name", width=360, minwidth=260, stretch=False)
